...
* What expertise might be lost during a slowdown which we would rather preserve, and by what means can we do so without weakening the intervention itself? E.g. the process for making [FOGBANK](https://en.wikipedia.org/wiki/Fogbank), a key input into certain nuclear warheads, was lost at one point, and tens of millions of dollars spent on rediscovering it. Cost overruns in new nuclear plants [have been blamed](https://ifp.org/nuclear-power-plant-construction-costs/) on a lack of skilled workers, due to not building any for many years.
