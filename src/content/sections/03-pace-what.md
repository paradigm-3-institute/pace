...
![A three-part AI R\&D production lifecycle from inputs and infrastructure, through capability development, to use and distribution, with an AI-assisted R\&D feedback loop.](/media/rd-feedback.svg)
